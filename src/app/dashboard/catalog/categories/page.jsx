...
import Tablecategories from "@/app/components/Table-categories/page";
import Toast from "@/app/(marketing)/components/Toast";
import AddCategoryButton from "@/app/(marketing)/components/addtocategory";
import Deletecategory from "@/app/(marketing)/components/deletecategory";
import Bulkactioncategory from "@/app/(marketing)/components/bulkactioncategory";
...
export default function categories() {
  ...
  return (
    <div className="min-h-screen bg-[#f8f7f4] dark:bg-gray-900 max-w-[1352px] pb-4 mx-auto">
      <div className="sm:flex sm:flex-col lg:flex-row justify-between items-start lg:items-center sm:gap-3 lg:gap-4 lg:py-8 py-3">
        ...
        <div className="flex flex-col sm:flex-row gap-2 items-center pt-4 sm:pt-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-2 w-full">
            <Bulkactioncategory disabled={selectedProducts.length === 0} />
            <Deletecategory disabled={selectedProducts.length === 0} />
            <AddCategoryButton />
          </div>
        </div>
      </div>
