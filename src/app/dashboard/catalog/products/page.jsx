...
import AddProductButton from "@/app/(marketing)/components/addtocart";
import BulkactionButton from "@/app/(marketing)/components/bulkaction";
import DeleteProduct from "@/app/(marketing)/components/deleteproduct";
import Tableproduct from "@/app/components/Table-product/page";
  ...
  return (
    <div className="min-h-screen bg-[#f8f7f4]  dark:bg-gray-900 max-w-[1350px] mx-auto pb-4 ">
      <div className="sm:flex sm:flex-col lg:flex-row justify-between items-start lg:items-center sm:gap-3 lg:gap-4 lg:py-8 py-3 ">
        <h1 className="text-[23px] font-bold text-gray-800 dark:text-gray-300">Products</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-2 items-center pt-4 sm:pt-0">
          ...
          <div className="flex flex-col sm:flex-row gap-2 w-full">
            <BulkactionButton disabled={selectedProducts.length === 0} />
