...
import Tablecoupons from "@/app/components/Table-coupons/page";
import Toast from "@/app/(marketing)/components/Toast";
import AddCouponButton from "@/app/(marketing)/components/addtocoupon";
import Bulkactioncoupon from "@/app/(marketing)/components/bulkactioncoupons";
  ...
  return (
    <div className="min-h-screen bg-[#f8f7f4] dark:bg-gray-900 max-w-[1350px] pb-4 mx-auto">
      <div className="sm:flex sm:flex-col lg:flex-row justify-between items-start lg:items-center sm:gap-3 lg:gap-4 lg:py-8 py-3">
        <h1 className="text-[23px] font-bold text-gray-800 dark:text-gray-300">Coupon</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-2 items-center pt-4 sm:pt-0">
          ...
          <div className="flex flex-col sm:flex-row gap-2 w-full">
            <Bulkactioncoupon disabled={selectedProducts.length === 0} />
            <DeleteProduct disabled={selectedProducts.length === 0} />
            <AddCouponButton />
          </div>
        </div>
      </div>
