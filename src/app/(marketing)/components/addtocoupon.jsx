        ...
        >
          ...
          <div className="px-6 pb-10 overflow-y-auto h-[calc(100%-80px)] dark:bg-gray-700 ">
            <div className=" sm:flex pt-8 pb-10 md:pb-8 ">
              ...
              <div className="md:mb-2   w-full sm:w-[66%] ml-auto border-2  dark:border-gray-600 border-dashed border-gray-300 rounded-md flex flex-col items-center justify-center p-5 text-center cursor-pointer hover:border-teal-500 transition">
            ...
            <div>
              <div className="sm:flex ">
                ...
                <input
                  type="text"
                  className=" w-full sm:w-[66%] ml-auto border border-gray-200 dark:border-gray-500 dark:bg-gray-800 rounded-md px-2 py-[9px]  focus:outline-none  focus:ring-teal-500 text-sm"
              ...
              <div className="sm:flex   md:pt-3   pb-6 ">
                ...
                <div className="flex items-center w-full sm:w-[66%] ml-auto border border-gray-300 dark:border-gray-500  rounded-md overflow-hidden">
                  <span className="px-3 text-gray-500 bg-gray-50 border-r py-[9px] items-center flex text-sm border-gray-300 dark:border-gray-500 dark:bg-gray-700 dark:text-white">
                    %
                  </span>
                  <input
                    type="text"
              ...
              <div className="sm:flex  py-6 pb-10 ">
                <label className="block  text-sm  pb-3 sm:pb-0 ">
                  Published
                </label>
