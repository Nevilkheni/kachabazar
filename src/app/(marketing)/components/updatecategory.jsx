          ...
          <div className="md:flex   justify-between mr-20">
            <div>
              ...
              <p className="text-bleck text-sm">
                Updated your Product category and necessary information from
                here
              </p>
            </div>
        ...
        <div className="px-6 pb-10 overflow-y-auto dark:bg-gray-700 h-[calc(100%-80px)] ">
          <div>
            ...
            <div className="sm:flex py-6">
              ...
              <textarea
                rows="4"
                className="w-full sm:w-[66%] ml-auto border border-gray-200 dark:border-gray-500 dark:bg-gray-800  rounded-md px-3 py-2  sm:py-[9px]  focus:outline-none 1  text-sm"
            ...
            <div className="sm:flex  pt-6  sm:mt-2">
