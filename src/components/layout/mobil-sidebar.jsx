...
export default function MobileSidebar({ open, setOpen }) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-16 left-0 h-full dark:bg-gray-800 bg-white shadow-lg z-50 flex flex-col overflow-hidden
        transition-transform duration-300 ease-in-out
        ${open ? "translate-x-0" : "-translate-x-full"} w-64 lg:hidden`}
      >
              ...
              {openMenus.Catalog && open && (
                <ul className="rounded-lg my-1 space-y-[7px] mr-2 py-3 px-2 ml-1 dark:bg-gray-900">
                  {[
                    ...
                    {
                      name: "Attributes",
                      path: "/dashboard/catalog/attributes",
                    },
                    ...
                    >
                      ...
                      <p className="text-[14px] font-normal ml-1">
                        {item.name}
                      </p>
                    </li>
                  ))}
            ...
            >
              ...
              {openMenus.Pages && open && (
                <ul className="rounded-lg my-1 space-y-[6px] mr-2 py-[11px] px-2 ml-1 dark:bg-gray-900">
                  <li
                    onClick={() =>
                      handleNavigate("/dashboard/pages/comingsoon")
                    }
                    className={`cursor-pointer font-normal flex items-center transition-colors duration-200 ${
